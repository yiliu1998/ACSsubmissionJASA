...
surv.A0 <- ggplot(nuis.df, aes(x = S0_end, fill = site)) +
  ...
  labs(
    title = paste0("S(t | A=0, X) at day ", t.check),
...
surv.A1 <- ggplot(nuis.df, aes(x = S1_end, fill = site)) +
  ...
  scale_fill_manual(values = site.cols) +
  labs(
    title = paste0("S(t | A=1, X) at day ", t.check),
    x = "Predicted survival probability",
    y = "Count",
    fill = "Site"
  ) +
...
cens.A0 <- ggplot(nuis.df, aes(x = G0_end, fill = site)) +
  ...
  scale_fill_manual(values = site.cols) +
  labs(
    title = paste0("G(t | A=0, X) at day ", t.check),
    x = "Predicted censoring probability",
    y = "Count",
    fill = "Site"
  ) +
  theme_bw() +
...
cens.A1 <- ggplot(nuis.df, aes(x = G1_end, fill = site)) +
  ...
  scale_fill_manual(values = site.cols) +
  labs(
    title = paste0("G(t | A=1, X) at day ", t.check),
    x = "Predicted censoring probability",
    y = "Count",
    fill = "Site"
  ) +
